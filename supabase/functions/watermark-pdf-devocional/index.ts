...
serve(async (req: Request) => {
  ...
  try {
    ...
    if (!firstName || !lastName || !email) {
      console.error("[watermark-pdf-devocional] Missing required parameters", { firstName, lastName, email });
    ...
    console.log("[watermark-pdf-devocional] Parameters received:", { firstName, lastName, email });

    // Gerar uma nova URL assinada para o PDF privado usando a chave de serviço
    console.log(`[watermark-pdf-devocional] Generating signed URL for bucket: ${BUCKET_NAME}, path: ${FILE_PATH}`);
