...
interface CourseLayoutProps {
  ...
  renderSidebarContent?: (props: { // Nova prop para renderizar conteúdo personalizado na sidebar
    courseData: CourseData;
    selectedLesson: Lesson | null;
    completionStatus: Record<string, boolean>;
    handleLessonClick: (lesson: Lesson) => void;
...
export function CourseLayout({
  ...
  courseLogoPath,
  resourceCoverPath,
  renderSidebarContent, // Destruturar a nova prop
}: CourseLayoutProps) {
    ...
    <div className="flex min-h-screen bg-background">
      <Sidebar collapsible="icon" className="border-r">
        ...
        <SidebarContent className="p-0">
          {renderSidebarContent ? ( // Renderiza o conteúdo personalizado se fornecido
          ...
          ) : ( // Caso contrário, renderiza a navegação padrão com Accordion
