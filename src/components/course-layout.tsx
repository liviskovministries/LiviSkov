...
import { 
  ...
  SidebarFooter,
  useSidebar,
  SidebarTrigger // Importação adicionada
...
interface CourseLayoutProps {
  ...
  handleVideoEnd: () => void;
  handleDownloadResource: () => Promise<void>; // Renomeado para ser mais genérico
  handleLogout: () => Promise<void>;
  courseLogoPath: string; // Novo prop para o caminho do logo do curso
  resourceCoverPath?: string; // Novo prop para a capa do recurso (livro)
}
...
export function CourseLayout({
  ...
  handleLessonClick,
  handleVideoEnd,
  handleDownloadResource, // Usar o novo nome
  handleLogout,
  courseLogoPath,
  resourceCoverPath,
}: CourseLayoutProps) {
